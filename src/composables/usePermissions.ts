...
export function usePermissions() {
  ...
  return {
    ...
    canViewPlans: computed(() => auth.hasPermission(PERMISSIONS.plans.view)),
    canCreatePlans: computed(() => auth.hasPermission(PERMISSIONS.plans.create)),
    canUpdatePlans: computed(() => auth.hasPermission(PERMISSIONS.plans.update)),
    canDeletePlans: computed(() => auth.hasPermission(PERMISSIONS.plans.delete)),
    canViewLeads: computed(() => auth.hasPermission(PERMISSIONS.leads.view)),

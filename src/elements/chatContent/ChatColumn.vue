...
export default defineComponent({
  ...
  setup() {
    return {
      chatColumn: [
        { img: IMAGE.product1, name: "K kumar", time: "1 mIn" },
        { img: IMAGE.product1, name: "Honey Risher", time: "2 mIn", userActive: "active" },
        { img: IMAGE.product1, name: "Liam Antony", time: "5 mIn" },
        { img: IMAGE.product1, name: "Ricky M", time: "4 mIn", userActive: "active" },
        { img: IMAGE.product1, name: "Elijah James", time: "2 mIn" },
        { img: IMAGE.product1, name: "Oliver Noah", time: "5 mIn", userActive: "active" },
        { img: IMAGE.product1, name: "Ricky M", time: "4 mIn", userActive: "active" },
        { img: IMAGE.product1, name: "Ricky Antony", time: "1 mIn", userActive: "active" },
        { img: IMAGE.product1, name: "Ricky Antony", time: "2 mIn", userActive: "active" },
        { img: IMAGE.product1, name: "Ankites Risher", time: "5 mIn", userActive: "active" },
        { img: IMAGE.product1, name: "Ricky M", time: "4 mIn", userActive: "active" },
        { img: IMAGE.product1, name: "William Risher", time: "2 mIn", userActive: "active" },
        { img: IMAGE.product1, name: "Oliver Noah", time: "5 mIn", userActive: "active" },
        { img: IMAGE.product1, name: "Ricky M", time: "4 mIn", userActive: "active" },
        { img: IMAGE.product1, name: "Elijah James", time: "2 mIn", userActive: "active" },
      ],
    };
  },
});

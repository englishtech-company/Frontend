        ...
        <div class="col-xl-3 col-xxl-4 mt-4">
            <div class="card">
                ...
                <div class="card-body height400 dz-scroll" id="about-2">
                    ...
                    <p class="fs-14">Dash is an open source cryptocurrency. It is an altcoin that was forked
                        from the Bitcoin protocol. It is also a decentralized autonomous organization (DAO)
                        run by a subset of its users, which are called "masternodes". The currency permits
                        transactions that can be untraceable.</p>
                    <p class="fs-14">Dash is an open source cryptocurrency. It is an altcoin that was forked
                        from the Bitcoin protocol. It is also a decentralized autonomous organization (DAO)
                        run by a subset of its users, which are called "masternodes". The currency permits
                        transactions that can be untraceable.</p>
                ...
                <div class="card-footer border-0 p-0 caret">
                    <RouterLink to="/coin-details" class="btn-link"><i class="fa fa-caret-down" aria-hidden="true"></i>
                    </RouterLink>
                </div>
            </div>
        </div>
        <div class="col-xl-9 col-xxl-8 mt-4">
            <div class="card">
                <div class="card-header pb-0 d-block d-sm-flex flex-wrap border-0 align-items-center">
                    ...
                    <div class="input-group detault-daterange me-3 mb-3" style="overflow: unset;">
                        <VueDatePicker v-model="date" range multi-calendars />
                    </div>
                    <div class="dropdown bootstrap-select btn-secondary style-1 default-select mb-3">
                ...
                <div class="card-body pb-0 pt-sm-3 pt-0">
                    <div class="row sp20 mb-4 align-items-center">
                        ...
                        <div
                            class="d-flex col-lg-8 col-xxl-8 co-sm-8 align-items-center mt-sm-0 mt-3 justify-content-end">
                            <div class="px-2 info-group">
                                <p class="fs-14 mb-1">24h% change</p>
                                <h3 class="fs-20 font-w600"><span class="text-success">1.64%</span>
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 7L7.00001 -8.77983e-06L14 7H7.00001H0Z" fill="#2BC155">
                                        </path>
                                    </svg>
                                </h3>
                            </div>
                    ...
                    <div id="chartBarRunning1" class="bar-chart">
                        <VueApexCharts height="350px" :options="state.chartOptions" :series="state.series" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-header d-sm-flex d-block pb-0 border-0">
                    ...
                    <div class="dropdown custom-dropdown d-block mt-3 mt-sm-0 mb-0">
                        <div class="btn btn-light d-flex align-items-center svg-btn" role="button"
                            ...
                            <svg class="me-2" width="25" height="25" viewBox="0 0 42 42" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <div class="row mt-4 align-items-center">
                                ...
                                <div class="col-sm-6 text-sm-right text-start">
                                    <a href="javascript:void(0);" class="btn  btn-success text-white mb-2">
                                        BUY
                                        <svg class="ms-4 scale3" width="16" height="16" viewBox="0 0 21 21" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-danger ms-4 mb-2">
                                        SELL
                                        <svg class="ms-4 scale5" width="16" height="16" viewBox="0 0 29 29" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="card">
                        ...
                        <div class="card-body p-3">
                            <div class="table-responsive">
                                <table class="table text-center bg-success-hover tr-rounded order-tbl">
                                    <thead>
                                        <tr>
                                            <th class="text-start icon_none">Price</th>
                                            <th class="text-center icon_none" icon_none>Amount</th>
                                            <th class="text-end icon_none">Total</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                        ...
                        <div class="card-footer border-0 p-0 caret">
                            <RouterLink to="/coin-details" class="btn-link"><i class="fa fa-caret-down"
                            ...
                            <div class="table-responsive">
                                <table class="table text-center bg-success-hover tr-rounded order-tbl">
                                    <thead>
                                        <tr>
                                            <th class="text-start icon_none">Price</th>
                                            <th class="text-center icon_none">Amount</th>
                                            <th class="text-end icon_none">Total</th>
                                        </tr>
                                    </thead>
                                    <tbody>

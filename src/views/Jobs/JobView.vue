          ...
          <div class="col-xl-12">
            <div class="card">
              <div class="card-header d-block">
                ...
                <div class="d-block">
                  <span class="me-2 d-inline-block"
                    ><a href="javascript:void(0);"><i class="text-primary fas fa-briefcase me-2"></i>Apcd company</a></span
                  >
                  <span class="me-2 d-inline-block"
                    ><a href="javascript:void(0);"><i class="text-primary fas fa-map-marker-alt me-2"></i>USA</a></span
                  >
                  <span class="d-inline-block"
                    ><a href="javascript:void(0);"><i class="text-primary fas fa-eye me-2"></i>View</a></span
                  >
                </div>
              </div>
              <div class="card-body pb-0">
                ...
                <div>
                  <p>
                    <i class="fas fa-dot-circle me-2 text-primary"></i>We are Looking For a PHP Doveloper, who is must be familiar with the PHP fundamentals& PHP
                    framwork. Experience with Laravel & mixs, Livewire
                  </p>
                  <p>
                    <i class="fas fa-dot-circle me-2 text-primary"></i>Good knowledge of SQL and related databases, with a preference for those with MySQL experience.
                  </p>
                ...
                <div class="row mb-3">
                  <div class="col-xl-6">
                    <ul class="list-style-1">
                      <li>
                        <label class="form-label mb-0 custom-label">Job Role :</label>
                        <p class="mb-0">PHP Developer</p>
                      </li>
                      <li>
                        <label class="form-label mb-0 custom-label">Role:</label>
                        <p class="mb-0">Front-End Doveloper</p>
                      </li>
                      <li>
                        <label class="form-label mb-0 custom-label">Min Salary:</label>
                        <p class="mb-0">$20,000</p>
                      </li>
                      <li>
                        <label class="form-label mb-0 custom-label">Max Salary:</label>
                        <p class="mb-0">$30,000</p>
                      </li>
                      <li>
                        <label class="form-label mb-0 custom-label">Job Tags:</label>
                        <p class="mb-0">PHP, Laravel, HTML5, SCSS,CSS, Javascript</p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-xl-6">
                    <ul class="list-style-1">
                      <li>
                        <label class="form-label mb-0 custom-label">Job Experience:</label>
                        <p class="mb-0">2yrs+</p>
                      </li>
                      <li>
                        <label class="form-label mb-0 custom-label">Launges:</label>
                        <p class="mb-0">Hindi, English</p>
                      </li>
                      <li>
                        <label class="form-label mb-0 custom-label">Locality:</label>
                        <p class="mb-0">USA, UK, India</p>
                      </li>
                      <li>
                        <label class="form-label mb-0 custom-label">Eligibility:</label>
                        <p class="mb-0">B.tech ,Any Graduate</p>
                      </li>
                      <li>
                        <label class="form-label mb-0 custom-label">Company :</label>
                        <p class="mb-0">Abcd corporation pvt ltd</p>
                      </li>
                    </ul>
                  </div>
                </div>

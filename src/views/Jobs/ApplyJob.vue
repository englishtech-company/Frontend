            ...
            <div class="card">
              <div class="card-body">
                ...
                <p class="mb-0">
                  ...
                  performance is assessed and compared over time.
                </p>
              </div>
              <div class="card-footer d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="mt-sm-0 mt-3">
                  ...
                  {{ " "
                  }}<a href="javascript:void(0);" class="btn btn-primary btn-sm apply-job" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
                    ><i class="far fa-check-circle me-2"></i>Apply Now</a
                  >
                </div>
              </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-4">
            ...
            <input type="email" class="form-control solid" placeholder="Email" aria-label="name" />
          </div>
          <div class="mb-4">
            <label class="form-label">Contact Number</label>
            <input type="email" class="form-control solid" placeholder="Phone Number" aria-label="name" />
          </div>
          ...
          <div class="mb-4">
            ...
            <input class="form-control form-control-md h-auto solid" id="formFilemd" type="file" />
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Apply Now</button>
        </div>
      </div>
    </div>
  </div>

                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped text-nowrap">
                                <thead>
                                    <tr>
                                        <th class="center icon_none">#</th>
                                        <th class="icon_none">Fees Type</th>
                                        <th class="icon_none">Frequency</th>
                                        <th class="right icon_none">Invoice number</th>
                                        <th class="center icon_none">Date</th>
                                        <th class="right icon_none">Amount</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-right">
                                ...
                                <button @click="printHandler" class="btn btn-light" type="button"> <i

                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Title" id="Title" type="text" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Price" id="Price" type="text" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea placeholder="Assets Details" id="Assets_Details" class="form-control"

            ...
            <div class="card-body">
              ...
              <form @submit.prevent="submitHandler">
                ...
                <div class="mb-4 position-relative">
                  ...
                  <input :type="show ? 'text' : 'password'" id="dlabPassword" class="form-control" value="123456" />
                ...
                <div class="form-row d-flex flex-wrap justify-content-between mt-4 mb-2">
                  ...
                  <div class="form-group ms-2">
                    <RouterLink class="btn-link" to="/page-forgot-password">Forgot Password?</RouterLink>
                  </div>
                </div>
              ...
              <div class="new-account mt-3">
                <p>Don't have an account? <RouterLink class="text-primary" to="/page-register">Sign up</RouterLink></p>
              </div>
            </div>
          </div>
        </div>

  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
        <div class="card">
          <img class="img-fluid rounded-top" src="../../assets/images/courses/pic1.jpg" alt="" />
          <div class="card-body">
            ...
            <RouterLink to="/about-courses" class="btn btn-primary">Read More</RouterLink>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
        <div class="card">
          <img class="img-fluid rounded-top" src="../../assets/images/courses/pic2.jpg" alt="" />
          <div class="card-body">
      ...
      <div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
        <div class="card">
          <img class="img-fluid rounded-top" src="../../assets/images/courses/pic3.jpg" alt="" />
          <div class="card-body">
      ...
      <div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
        <div class="card">
          <img class="img-fluid rounded-top" src="../../assets/images/courses/pic4.jpg" alt="" />
          <div class="card-body">
      ...
      <div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
        <div class="card">
          <img class="img-fluid rounded-top" src="../../assets/images/courses/pic5.jpg" alt="" />
          <div class="card-body">
            <h4>When Is the Best Time to Take an Education Course?</h4>
            <ul class="list-group mb-3 list-group-flush">
              <li class="list-group-item px-0 border-top-0 d-flex justify-content-between">
      ...
      <div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
        <div class="card">
          <img class="img-fluid rounded-top" src="../../assets/images/courses/pic6.jpg" alt="" />
          <div class="card-body">
            <h4>Education Courses: A Guide to Unlocking Your Potential</h4>
            <ul class="list-group mb-3 list-group-flush">
              <li class="list-group-item px-0 border-top-0 d-flex justify-content-between">
      ...
      <div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
        <div class="card">
          <img class="img-fluid rounded-top" src="../../assets/images/courses/pic7.jpg" alt="" />
          <div class="card-body">
            <h4>A Comprehensive Guide to Taking an Education Course</h4>
            <ul class="list-group mb-3 list-group-flush">
              <li class="list-group-item px-0 border-top-0 d-flex justify-content-between">
      ...
      <div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
        <div class="card">
          <img class="img-fluid rounded-top" src="../../assets/images/courses/pic8.jpg" alt="" />
          <div class="card-body">
            <h4>Why Should You Consider Taking an Education Course?</h4>
            <ul class="list-group mb-3 list-group-flush">
              <li class="list-group-item px-0 border-top-0 d-flex justify-content-between">

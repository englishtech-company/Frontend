            ...
            <div class="card">
              <div class="text-center p-3 overlay-box" style="background-image: url(images/big/img1.jpg)">
                <div class="profile-photo">
                  <img src="../../assets/images/profile/profile.png" class="img-fluid rounded-circle" alt="" width="100" />
                </div>
                ...
                <div class="profile-tab">
                  <div class="custom-tab-1">
                    <ul class="nav nav-tabs" role="tablist">
                      <li class="nav-item" role="presentation"><a href="#my-posts" data-bs-toggle="tab" class="nav-link active show" aria-selected="true" role="tab">Posts</a></li>
                      <li class="nav-item" role="presentation"><a href="#about-me" data-bs-toggle="tab" class="nav-link" aria-selected="false" tabindex="-1" role="tab">About Me</a></li>
                    </ul>
                      ...
                      <div id="my-posts" class="tab-pane fade active show" role="tabpanel">
                        <div class="my-post-content pt-3">
                          ...
                          <div class="profile-uoloaded-post pb-3">
                            ...
                            <RouterLink class="post-title" to="/post-details">
                              <h3>"Breakthrough Study Reveals Promising New Treatment Strategy for Alzheimer's Disease</h3>
                            </RouterLink>
                            <p>
                              A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire
                              soul like these sweet morning of spare which enjoy whole heart.

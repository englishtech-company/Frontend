<template>
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-xl-12">
        <RouterLink to="/email-template" class="btn btn-primary mb-md-5 mb-3">List Email Template</RouterLink>
      </div>
      <div class="col-xl-12">
        <div class="filter cm-content-box box-primary">
          <div class="content-title SlideToolHeader">
            <div class="cpa"><i class="fa-solid fa-envelope"></i> Add Email Template</div>
            <div class="tools">
              <a @click="dropDown = !dropDown" href="#addContent" :class="`${dropDown ? '' : 'expand'} SlideToolHeader`"
                data-bs-toggle="collapse" data-bs-target="#addContent" aria-expanded="true"
                aria-controls="addContent"><i class="fal fa-angle-down"></i></a>
            </div>
          </div>
          <div class="cm-content-body form excerpt collapse show" id="addContent">
            <div class="card-body">
              <div class="row">
                <div class="col-xl-6">
                  <form>
                    <div class="mb-3">
                      ...
                      <div class="form-text">Title should be meaning full like : registration email, forgot password
                        email.</div>
                    </div>
                    <div class="mb-3">
                ...
                <div class="col-xl-6">
                  ...
                  <div class="new-scroll">
                    ...
                    <div class="d-grid mb-3">
                      ...
                      <span>#MESSAGE#: Delivery details or expected deliery date. This message will deliver to
                        customer.</span>
                ...
                <div class="col-xl-12">
                  ...
                  <div class="form-text mb-3">This design will show in recieved email and place holders will replace
                    with dynamic content.</div>
                </div>

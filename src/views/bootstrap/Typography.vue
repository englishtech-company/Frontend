            ...
            <div class="row justify-content-between">
              ...
              <div class="col-xl-4 col-xxl-12">
                <div class="mb-4">
                  ...
                  <p>
                    Use tags
                    <code>text-start, text-center, text-end</code> for get
                    desire text.
                  </p>
                </div>
                <div class="card-content">
              ...
              <div class="col-lg-6">
                <div class="mb-4">
                  ...
                  <p>
                    Use tags
                    <code>text-sm-start, text-md-start, text-lg-start,
                      text-xl-start</code>
                    for get desire text.
                  </p>
                </div>
              ...
              <div class="col-lg-4">
                ...
                <div class="card-content">
                  <address>
                    ...
                    <br />795 Folsom Ave, Suite 600<br />San Francisco, CA
              ...
              <div class="col-lg-4 mb-3">
                <div class="mb-4">
                  <h4 class="card-title card-intro-title mb-1">
                    Description Text
                  </h4>
                  <p>
              ...
              <div class="col-lg-4 mb-3">
                ...
                <ul class="list-icons">
                  <li>
                    <a href="javascript:void(0)"><span class="align-middle me-2"><i
                  ...
                  <li>
                    <a href="javascript:void(0)"><span class="align-middle me-2"><i
                          class="fa fa-check text-info"></i></span>Integer molestie lorem at massa</a>
                  </li>
                </ul>
              </div>
              <div class="col-lg-4 mb-3">
                ...
                <ul class="list-icons">
                  ...
                  <li>
                    <a href="javascript:void(0)"><span class="align-middle me-2"><i
                          class="fa fa-chevron-right"></i></span>Integer molestie lorem at massa</a>
                  </li>
                </ul>
              </div>
            </div>

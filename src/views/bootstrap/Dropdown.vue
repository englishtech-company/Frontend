      ...
      <div class="col-xl-4 col-lg-12">
        <div class="card">
          <div class="card-header d-block">
            ...
            <p class="m-0 subtitle">
              The <code>.dropdown-divider</code> class is used to separate links
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="basic-dropdown">
              ...
              <div class="btn-group dropup mb-1 me-1">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">
                  Dropup
                </button>
                <div class="dropdown-menu">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="basic-dropdown">
              ...
              <div class="btn-group dropend mb-1 me-1">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">
                  Dropright
                </button>
                <div class="dropdown-menu">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="basic-dropdown">
              ...
              <div class="btn-group dropstart mb-1 me-1">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">
                  dropstart
                </button>
                <div class="dropdown-menu">
            ...
            <div class="row">
              ...
              <div class="col-xl-3">
                <div class="dropdown custom-dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end" style="">
                    <a class="dropdown-item" href="#">May 20, 2018 &nbsp; To &nbsp; June 20, 2018</a>
                    <a class="dropdown-item" href="#">July 20, 2018 &nbsp; To &nbsp; August 20, 2018</a>
                  </div>
                </div>
              </div>
              <div class="col-xl-3">

        ...
        <div class="card">
          <div class="card-body p-4">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
              ...
              </div><a class="carousel-control-prev" href="#carouselExampleIndicators" data-bs-slide="prev"><span
          ...
          <div class="card-body p-4">
            ...
            <div class="bootstrap-carousel">
              <div id="carouselExampleIndicators2" class="carousel slide" data-bs-ride="carousel">
                <ol class="carousel-indicators">
                  <li data-bs-target="#carouselExampleIndicators2" data-bs-slide-to="0" class=""></li>
                  <li data-bs-target="#carouselExampleIndicators2" data-bs-slide-to="1" class=""></li>
                  <li data-bs-target="#carouselExampleIndicators2" data-bs-slide-to="2" class="active"
                ...
                </div><a class="carousel-control-prev" href="#carouselExampleIndicators2" data-bs-slide="prev"><span
                    class="carousel-control-prev-icon"></span> <span class="sr-only">Previous</span> </a><a
          ...
          <div class="card-body p-4">
            ...
            <div class="bootstrap-carousel">
              <div data-bs-ride="carousel" class="carousel slide" id="carouselExampleCaptions">
                <ol class="carousel-indicators">
                  <li class="" data-bs-slide-to="0" data-bs-target="#carouselExampleCaptions">
                  </li>
                  <li data-bs-slide-to="1" data-bs-target="#carouselExampleCaptions" class=""></li>
                  <li data-bs-slide-to="2" data-bs-target="#carouselExampleCaptions" class="active" aria-current="true">
                  </li>
                </ol>
                <div class="carousel-inner">
                  <div class="carousel-item">

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="bootstrap-media">
                            <div class="media">
                                <img class="me-3 img-fluid rounded" src="../../assets/images/avatar/1.jpg"
                                    alt="DexignZone" width="60">
                            ...
                            <div class="media mt-4">
                                <img class="me-3 img-fluid rounded" src="../../assets/images/avatar/7.jpg"
                                    alt="DexignZone" width="60">
                                <div class="media-body">
                                    <h5 class="mt-0">Media heading</h5>
                                    <p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus
            ...
            <div class="col-xl-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="bootstrap-media">
                            <div class="media">
                                <img class="me-3 rounded" src="../../assets/images/avatar/2.jpg" alt="DexignZone"
                                    width="60">
                                <div class="media-body">
                                    <h5 class="mt-0">Media heading</h5>
                                    <p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus
                                    ...
                                    <div class="media mt-4">
                                        <a class="pe-3" href="#">
                                            <img class="rounded" src="../../assets/images/avatar/3.jpg" alt="DexignZone"
                                                width="60">
                                        </a>
                                        <div class="media-body">
                                            <h5 class="mt-0">Media heading</h5>
            ...
            <div class="col-xl-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="bootstrap-media">
                            <div class="media">
                                <img class="align-self-start me-3 rounded" src="../../assets/images/avatar/4.jpg"
                                    alt="DexignZone" width="60">
                                <div class="media-body">
            ...
            <div class="col-xl-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="bootstrap-media">
                            <div class="media">
                                <img class="align-self-center me-3 rounded" src="../../assets/images/avatar/5.jpg"
                                    alt="DexignZone" width="60">
                                <div class="media-body">
            ...
            <div class="col-xl-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="bootstrap-media">
                            <div class="media">
                                <img class="align-self-end me-3 rounded" src="../../assets/images/avatar/6.jpg"
                                    alt="DexignZone" width="60">
                                <div class="media-body">
                    ...
                    <div class="card-body">
                        <div class="bootstrap-media">
                            <div class="media">
                                ...
                                <img class="ms-3 rounded" src="../../assets/images/avatar/7.jpg" alt="DexignZone"
                                    width="60">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="bootstrap-media">
                            <ul class="list-unstyled">
                                <li class="media">
                                    <img class="me-3 rounded" src="../../assets/images/avatar/8.jpg" alt="DexignZone"
                                        width="60">
                                    <div class="media-body">
                                        ...
                                        <p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus
                                            ...
                                            Donec lacinia congue felis in faucibus. vulputate at, tempus viverra turpis.
                                            Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue
                                            felis in faucibus.</p>
                                    </div>
                                </li>
                                <li class="media my-4">
                                    <img class="me-3 rounded" src="../../assets/images/avatar/1.jpg" alt="DexignZone"
                                        width="60">
                                    <div class="media-body">
                                        <h5 class="mt-0">List-based media object</h5>
                                        <p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus

    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn light btn-secondary">
              Secondary
            </button>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-danger">
              Remove
              <span class="btn-icon-end"><i class="fas fa-times"></i></span>
            </button>
      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            <button type="button" class="btn tp-btn btn-primary">
              Primary
            </button>
            <button type="button" class="btn tp-btn btn-secondary">
              Secondary
            </button>
            <button type="button" class="btn tp-btn btn-success">
              Success
            </button>
            <button type="button" class="btn tp-btn btn-danger">Danger</button>
            <button type="button" class="btn tp-btn btn-warning">
              Warning
            </button>
      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn tp-btn-light btn-danger">
              Danger
            </button>
            <button type="button" class="btn tp-btn-light btn-warning">
              Warning
            </button>
            <button type="button" class="btn tp-btn-light btn-info">
              Info
            </button>
            <button type="button" class="btn tp-btn-light btn-light">
              Light
            </button>
            <button type="button" class="btn tp-btn-light btn-dark">
              Dark
            </button>
          </div>
        </div>
      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            <button type="button" class="btn btn-rounded btn-primary" disabled>
              Primary
            </button>
            <button type="button" class="btn btn-rounded btn-secondary" disabled>
              Secondary
            </button>
            <button type="button" class="btn btn-rounded btn-success" disabled>
              Success
            </button>
            <button type="button" class="btn btn-rounded btn-danger" disabled>
              Danger
            </button>
            <button type="button" class="btn btn-rounded btn-warning" disabled>
              Warning
            </button>
            <button type="button" class="btn btn-rounded btn-info" disabled>
              Info
            </button>
          </div>
        </div>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header d-block">
            ...
            <p class="mb-0 subtitle">
              add <code>.btn-facebook, .btn-twitter, .btn-youtube...</code> to
              change the style
            </p>
          </div>
          <div class="card-body">
            ...
            <button type="button" class="btn btn-twitter">
              Twitter
              <span class="btn-icon-end"><i class="fab fa-twitter"></i></span>
            </button>
            <button type="button" class="btn btn-youtube">
              Youtube
              <span class="btn-icon-end"><i class="fab fa-youtube"></i></span>
            </button>
            ...
            <button type="button" class="btn btn-google">
              Google
              <span class="btn-icon-end"><i class="fab fa-google"></i></span>
            </button>
            <button type="button" class="btn btn-snapchat">
              Snapchat
              <span class="btn-icon-end"><i class="fab fa-snapchat"></i></span>
            </button>
            <button type="button" class="btn btn-whatsapp">
              Whatsapp
              <span class="btn-icon-end"><i class="fab fa-whatsapp"></i></span>
            </button>
            <button type="button" class="btn btn-tumblr">
              Tumblr
              <span class="btn-icon-end"><i class="fab fa-tumblr"></i></span>
            </button>
            <button type="button" class="btn btn-reddit">
              Reddit
              <span class="btn-icon-end"><i class="fab fa-reddit"></i></span>
            </button>
            <button type="button" class="btn btn-spotify">
              Spotify
              <span class="btn-icon-end"><i class="fab fa-spotify"></i></span>
            </button>
            <button type="button" class="btn btn-yahoo">
              Yahoo
              <span class="btn-icon-end"><i class="fab fa-yahoo"></i></span>
            </button>
            <button type="button" class="btn btn-dribbble">
              Dribbble
              <span class="btn-icon-end"><i class="fab fa-dribbble"></i></span>
            </button>
            <button type="button" class="btn btn-skype">
              Skype
              <span class="btn-icon-end"><i class="fab fa-skype"></i></span>
            </button>
            <button type="button" class="btn btn-quora">
              Quora
              <span class="btn-icon-end"><i class="fab fa-quora"></i></span>
            </button>
            <button type="button" class="btn btn-vimeo">
              Vimeo
              <span class="btn-icon-end"><i class="fab fa-vimeo-v"></i></span>
            </button>
          </div>
        </div>
      </div>

                ...
                <div class="dropdown ms-auto">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li class="dropdown-item">
                      <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#addCloseFriendModal"><i
                          class="fa fa-users text-primary me-2"></i> Add to close friends</a>
                    </li>
                    <li class="dropdown-item">
                      <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#createGroupModal"><i
                          class="fa fa-plus text-primary me-2"></i> Create group</a>
                    </li>
                    <li class="dropdown-item">
                      <a href="javascript:void(0);" class="text-danger sweet-confirm" @click="blockHandler"><i
                          class="fa fa-ban text-danger me-2"></i> Block</a>
                    </li>
                  </ul>
                </div>
              </div>
                        ...
                        <div class="modal-body">
                          <form class="comment-form">
                            <div class="row">
                              <div class="col-lg-6">
                                <div class="mb-3">
                                  <label class=" font-w600 form-label">Name <span
                              ...
                              <div class="col-lg-6">
                                <div class="mb-3">
                                  <label class=" font-w600 form-label">Email <span
                                      class="required">*</span></label>
                              ...
                              <div class="col-lg-12">
                                <div class="mb-3">
                                  ...
                                  <textarea rows="4" class="form-control h-50" name="comment"
            ...
            <div class="card">
              <div class="card-body">
                <div class="profile-blog">
                  ...
                  <h4>
                    <RouterLink to="/post-details">Darwin Creative Agency Theme</RouterLink>
                  </h4>
                  <p class="mb-0">
            ...
            <div class="card-body">
              <div class="profile-interest">
                ...
                <Lightgallery class="row mt-4 sp4" :settings="{ speed: 500, plugins: plugins }">
                  <a :href="`${img}`" class="lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6"
                    v-for="({ img }, ind) in gallery" :key="ind">
              ...
              <div class="profile-news">
                ...
                <div class="media pt-3 pb-3">
                  ...
                  <div class="media-body">
                    <h5 class="m-b-5">
                      <RouterLink to="/post-details">Collection of textile samples</RouterLink>
                    </h5>
                ...
                <div class="media pt-3 pb-3">
                  ...
                  <div class="media-body">
                    <h5 class="m-b-5">
                      <RouterLink to="/post-details">Sales Team Collaboration</RouterLink>
                    </h5>
                    <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                  </div>
                </div>
                <div class="media pt-3 pb-3">
                  ...
                  <div class="media-body">
                    <h5 class="m-b-5">
                      <RouterLink to="/post-details">Adapting to Technological Changes</RouterLink>
                    </h5>
                    <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                  </div>
                </div>
                  ...
                  <div id="my-posts" class="tab-pane fade active show">
                    <div class="my-post-content pt-3">
                      <div class="post-input">
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary light me-2 px-3" data-bs-toggle="modal"
                        ...
                        <div class="modal fade" id="linkModal">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <a class="btn-social me-1 facebook" href="javascript:void(0)"><i
                                    class="fab fa-facebook-f"></i></a>
                                <a class="btn-social me-1 google-plus" href="javascript:void(0)"><i
                                    class="fab fa-google-plus-g"></i></a>
                                <a class="btn-social me-1 linkedin" href="javascript:void(0)"><i
                                    class="fab fa-linkedin-in"></i></a>
                                <a class="btn-social me-1 instagram" href="javascript:void(0)"><i
                                    class="fab fa-instagram"></i></a>
                                <a class="btn-social me-1 twitter" href="javascript:void(0)"><i
                                    class="fab fa-twitter"></i></a>
                                <a class="btn-social me-1 youtube" href="javascript:void(0)"><i
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body pt-0">
                                <textarea name="textarea" id="textarea2" cols="30" rows="5"
                      ...
                      <div class="profile-uoloaded-post border-bottom-1 pb-5" v-for="({ img }, ind) in post" :key="ind">
                        ...
                        <RouterLink class="post-title" to="/post-details">
                          <h3 class="">Collection of textile samples lay spread</h3>
                        </RouterLink>
                        <p>
                          A wonderful serenity has take possession of my entire soul like these sweet morning of spare
                          which enjoy whole heart.A wonderful serenity has take possession of my entire
                        ...
                        <form>
                          ...
                          <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                              ...
                              <div class="dropdown bootstrap-select form-control default-select wide dropup">
                                <JobSelectOption
                                  :options="[{ title: 'Alabama' }, { title: 'Wyoming' }, { title: 'dlf' }]" />
                              </div>
                            </div>
...
export default defineComponent({
  ...
  setup() {
    return {
      ...
      gallery: [{ img: IMAGE.profilePic2 }, { img: IMAGE.profilePic3 }, { img: IMAGE.profilePic4 }, { img: IMAGE.profilePic4 }, { img: IMAGE.profilePic3 }, { img: IMAGE.profilePic2 }],
    };
  },

      ...
      <div class="col-lg-12">
        <div class="card mt-3">
          <div class="card-header">
            Invoice <strong>20/6/2024</strong>
              ...
              <div
                ...
                <div class="row align-items-center">
                    ...
                    <div class="brand-logo mb-3">
                      <div class="brand-logo justify-content-start p-0 mb-3">
                        <svg class="logo-abbr me-2" xmlns="http://www.w3.org/2000/svg"
                          xmlns:xlink="http://www.w3.org/1999/xlink" width="84" height="67" viewBox="0 0 84 67"
                          fill="none">
                          <mask id="mask0_135_5" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="4" y="0"
                            width="76" height="66">
                            <rect x="4" width="76" height="66" fill="url(#pattern0)"></rect>
                          </mask>
                          <g mask="url(#mask0_135_5)">
                            <rect x="-3" y="-1" width="90" height="68" fill="var(--primary)"></rect>
                          </g>
                          <defs>
                        ...
                        <img class="logo-compact w-50" src="../../../assets/images/logo-text.png" alt="/">
                      </div>
                    </div>
                  ...
                  <div class="col-sm-3 mt-3">
                    <img src="../../../assets/images/qr.png" alt="" class="img-fluid width110" />
                  </div>
                </div>
              </div>
            </div>

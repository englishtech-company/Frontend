          ...
          <div class="card-body">
            ...
            <div class="">
              <div id="external-events" class="my-3">
                ...
                <div class="external-event btn-danger light" data-class="bg-danger"><i class="fa fa-move"></i>Meet
                  manager</div>
                <div class="external-event btn-info light" data-class="bg-info"><i class="fa fa-move"></i>Create New
                  theme</div>
                <div class="external-event btn-dark light" data-class="bg-dark"><i class="fa fa-move"></i>Project Launch
                </div>
              ...
              <form>
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input class="form-control form-white" placeholder="Category Name" type="text"
                      name="category-name" />
                  </div>
                  <div class="col-md-6">

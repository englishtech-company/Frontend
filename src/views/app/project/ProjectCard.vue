          ...
          <div class="card-body">
            <div class="d-flex mb-4 align-items-start">
              <div class="dz-media me-3">
                <img
                  src="../../../assets/images/logos/pic1.jpg"
                  class="img-fluid"
                  alt=""
                />
              </div>
              <div class="me-auto">
                ...
                <h5 class="title font-w600 mb-2">
                  <RouterLink to="/post-details" class="text-black"
                    >Redesign Zenix Mobile App</RouterLink
                  >
                </h5>
            ...
            <div class="d-flex flex-wrap align-items-center">
              <div class="me-auto mb-4">
                ...
                <ul class="users-lg">
                  ...
                  <li>
                    <img src="../../../assets/images/users/pic5.jpg" alt="" />
                  </li>
                  <li>
                    <img src="../../../assets/images/users/pic6.jpg" alt="" />
                  </li>
                  <li>
                    <img src="../../../assets/images/users/pic7.jpg" alt="" />
                  </li>
                </ul>
              </div>
            ...
            <div class="row">
              <div class="col-6">
                <div>
                  Questions:<span class="text-black ms-3 font-w600">56</span>
                </div>
                <div>
                  Comments:<span class="text-black ms-3 font-w600">200</span>
                </div>
              </div>
              <div class="col-6">
                <h6>
        ...
        <div class="card project-card">
          <div class="card-body">
            <div class="d-flex mb-4 align-items-start">
              <div class="dz-media me-3">
                <img
                  src="../../../assets/images/logos/pic2.jpg"
                  class="img-fluid"
                  alt=""
                />
              </div>
              ...
              <span class="badge badge-info d-sm-inline-block d-none"
                >Compeleted</span
              >
            </div>
            <p class="mb-4">
        ...
        <div class="card project-card">
          <div class="card-body">
            <div class="d-flex mb-4 align-items-start">
              ...
              <span class="badge badge-danger d-sm-inline-block d-none"
                >Compeleted</span
              >
            </div>
            <p class="mb-4">
        ...
        <div class="card project-card">
          <div class="card-body">
            <div class="d-flex mb-4 align-items-start">
              ...
              <span class="badge badge-secondary d-sm-inline-block d-none"
                >Compeleted</span
              >
            </div>
            <p class="mb-4">

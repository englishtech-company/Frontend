        ...
        <ul class="nav nav-tabs style-2">
          ...
          <li class="nav-item">
            <a
              ...
              aria-expanded="false"
              >On Progress
              <span class="badge badge-pill badge-info shadow-info">2</span></a
            >
          </li>
          <li class="nav-item">
            <a
      ...
      <div class="tab-pane fade active show" id="navpills-1">
          ...
          <div class="project-info">
            <div class="col-xl-3 my-2 col-lg-4 col-sm-6">
              ...
              <h5 class="title font-w600 mb-2">
                <RouterLink to="/post-details" class="text-black"
                  >Redesign Kripton Mobile App</RouterLink
                >
              </h5>
              <div class="text-dark">
                <i class="far fa-calendar me-3" aria-hidden="true"></i>Created
                on Sep 8th, 2020
              </div>
            </div>
            ...
            <div class="col-xl-2 my-2 col-lg-6 col-sm-6">
              <div class="d-flex project-status align-items-center">
                <span class="btn bgl-warning text-warning status-btn me-3"
                  >Pending</span
                >
                <div class="dropdown">
                  <a
        ...
        <div class="card">
          <div class="project-info">
            <div class="col-xl-3 my-2 col-lg-4 col-sm-6">
              ...
              <h5 class="title font-w600 mb-2">
                <RouterLink to="/post-details" class="text-black"
                  >Build Branding Persona for Etza.id</RouterLink
                >
              </h5>
              <div class="text-dark">
                <i class="far fa-calendar me-3" aria-hidden="true"></i>Created
            ...
            <div class="col-xl-2 my-2 col-lg-4 col-sm-6">
              <div class="d-flex align-items-center">
                <div class="project-media">
                  <img src="../../../assets/images/users/pic4.jpg" alt="" />
                </div>
                <div class="ms-2">
                  <span>Client</span>
            ...
            <div class="col-xl-2 my-2 col-lg-6 col-sm-6">
              <div class="d-flex project-status align-items-center">
                <span class="btn bgl-info text-info status-btn me-3"
                  >Progress</span
                >
                <div class="dropdown">
                  <a
        ...
        <div class="card">
          <div class="project-info">
            <div class="col-xl-3 my-2 col-lg-4 col-sm-6">
              ...
              <h5 class="title font-w600 mb-2">
                <RouterLink to="/post-details" class="text-black"
                  >Manage SEO for Eclan Company P..</RouterLink
                >
              </h5>
              <div class="text-dark">
                <i class="far fa-calendar me-3" aria-hidden="true"></i>Created
            ...
            <div class="col-xl-2 my-2 col-lg-4 col-sm-6">
              <div class="d-flex align-items-center">
                <div class="project-media">
                  <img src="../../../assets/images/users/pic8.jpg" alt="" />
                </div>
                <div class="ms-2">
                  <span>Client</span>
        ...
        <div class="card">
          <div class="project-info">
            <div class="col-xl-3 my-2 col-lg-4 col-sm-6">
              ...
              <h5 class="title font-w600 mb-2">
                <RouterLink to="/post-details" class="text-black"
                  >Reduce Website Page Size Omah</RouterLink
                >
              </h5>
              <div class="text-dark">
                <i class="far fa-calendar me-3" aria-hidden="true"></i>Created
            ...
            <div class="col-xl-2 my-2 col-lg-4 col-sm-6">
              <div class="d-flex align-items-center">
                <div class="project-media">
                  <span class="img-placeholder bgl-success text-success"
                    >BS</span
                  >
                </div>
                <div class="ms-2">
        ...
        <div class="card">
          <div class="project-info">
            ...
            <div class="col-xl-2 my-2 col-lg-6 col-sm-6">
              <div class="d-flex project-status align-items-center">
                <span class="btn bgl-danger text-danger status-btn me-3"
                  >Closed</span
                >
                <div class="dropdown">
                  <a

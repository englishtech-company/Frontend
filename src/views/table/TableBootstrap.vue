              ...
              <table class="table table-responsive-md">
                    ...
                    <th style="width:50px;">
                      <div class="form-check custom-checkbox checkbox-primary">
                        <input type="checkbox" class="form-check-input" id="checkAll" required
                          @click="allInputChecked = !allInputChecked">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center"><img src="../../assets/images/avatar/1.jpg"
                          class="rounded-lg me-2" alt="" width="24"> <span class="w-space-no">Jackson</span></div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center"><img src="../../assets/images/avatar/2.jpg"
                          class="rounded-lg me-2" alt="" width="24"> <span class="w-space-no">Sunny</span></div>
                    </td>
                    <td>example@example.com </td>
                    <td>01 August 2022</td>
                    <td>
                      <div class="d-flex align-items-center"><i class="fa fa-circle text-danger me-1"></i> Canceled
                      </div>
                    </td>
                    <td>
                      <div class="d-flex">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center"><img src="../../assets/images/avatar/3.jpg"
                          class="rounded-lg me-2" alt="" width="24"> <span class="w-space-no">Bobby</span></div>
                    </td>
                    <td>hello@example.com </td>
                    <td>01 August 2023</td>
                    <td>
                      <div class="d-flex align-items-center"><i class="fa fa-circle text-warning me-1"></i> Pending
                      </div>
                    </td>
                    <td>
                      <div class="d-flex">
              ...
              <table class="table table-bordered verticle-middle table-responsive-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-end">
                      <span>
                        <a href="javascript:void()" class="me-4" data-bs-toggle="tooltip" data-placement="top"
                          title="Edit"><i class="fa fa-pencil color-muted"></i> </a>
                        <a href="javascript:void()" data-bs-toggle="tooltip" data-placement="top" title="Close"><i
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-end"><span><a href="javascript:void()" class="me-4" data-bs-toggle="tooltip"
                          data-placement="top" title="Edit"><i class="fa fa-pencil color-muted"></i> </a><a
                          href="javascript:void()" data-bs-toggle="tooltip" data-placement="top" title="Close"><i

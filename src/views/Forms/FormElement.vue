            ...
            <div class="basic-form">
              <form>
                <div class="dropdown bootstrap-select default-select form-control wide mb-3">
                  <JobSelectOption :options="options" />
                </div>
                <div class="dropdown bootstrap-select default-select form-control wide mb-3">
                  <JobSelectOption :options="options" />
                </div>
              ...
              <form>
                <div class="row align-items-center">
                  <div class="col-auto my-1">
                    ...
                    <v-select class="multi-select" style="width: 130px" placeholder="Choose..." :options="[
                      { title: 'Choose...' },
                      { title: 'One' },
                      { title: 'Two' },
                      { title: 'Three' },
...
export default defineComponent({
  name: "formElements_",
  components: { FormSelectOptin, JobSelectOption, vSelect },
  setup() {
    // @ts-ignore
    const options = ref([
      { title: "Option 1" },

...
// const resizeHandler = () => {
//   scrollHeight.value = scrollHeight.value / 2;
// };
...
<template>
  <div class="tab-pane fade active show" id="chat">
    <div :class="`card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box ${openChat ? ' d-none' : ''}`">
      ...
      <div class="card-body contacts_body p-0 dz-scroll" id="DZ_W_Contacts_Body" style="overflow: auto">
        <ul class="contacts">
